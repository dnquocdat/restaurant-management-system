...
import {
  ...
  searchEmployees,
  getEmployeeDetails as getEmployeeDetailsService, // thêm chỗ này ann
...
export const searchEmployeesController = async (req, res, next) => {
  ...
  const { employees, totalRecords } = await searchEmployees({
    query,
    branch_id,
    department_id,
    page: parsedPage,
...
// Thêm chỗ này ann
// get employee details with employee id
