...
async function searchMemberCards({ query = '', page = 1, limit = 10 }) {
    ...
    const p_category = '';
    const p_id_name = 'member_card_id';
    const p_selectFields = 'member_card_id, member_id, member_name, member_phone_number, member_gender, card_issuer, branch_created, is_active, created_at';
    const p_joinClause = ''; 
    const p_branch_name = '';
    const p_branch_id = '';
